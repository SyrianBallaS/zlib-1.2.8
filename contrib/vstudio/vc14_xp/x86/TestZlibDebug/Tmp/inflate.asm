; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24215.1 
	...
	TITLE	C:\Users\Sam\Repos\zlib-1.2.8\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG81104 DB	'1.2.8', 00H
	ORG $+2
$SG81658 DB	'incorrect header check', 00H
	ORG $+1
$SG81660 DB	'unknown compression method', 00H
	ORG $+1
$SG81664 DB	'invalid window size', 00H
$SG81668 DB	'unknown compression method', 00H
	ORG $+1
$SG81670 DB	'unknown header flags set', 00H
	ORG $+3
$SG81717 DB	'header crc mismatch', 00H
$SG81734 DB	'invalid block type', 00H
	ORG $+1
$SG81738 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG81750 DB	'too many length or distance symbols', 00H
$SG81754 DB	'invalid code lengths set', 00H
	ORG $+3
$SG81764 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG81770 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG81773 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG81775 DB	'invalid literal/lengths set', 00H
$SG81777 DB	'invalid distances set', 00H
	ORG $+2
$SG81791 DB	'invalid literal/length code', 00H
$SG81802 DB	'invalid distance code', 00H
	ORG $+2
$SG81812 DB	'invalid distance too far back', 00H
	ORG $+2
$SG81825 DB	'incorrect data check', 00H
	ORG $+3
$SG81830 DB	'incorrect length check', 00H
_DATA	ENDS
PUBLIC	_inflate@8
...
; File c:\users\sam\repos\zlib-1.2.8\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 189  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG81104[edx]
	cmp	eax, ecx
...
; 662  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81658
...
; 667  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81660
...
; 676  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81664
...
; 691  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81668
...
; 696  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81670
...
; 800  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81717
...
; 859  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81734
...
; 868  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81738
...
; 907  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81750
...
; 929  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81754
...
; 952  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81764
...
; 975  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81770
...
; 989  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81773
...
; 1003 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81775
...
; 1012 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81777
...
; 1064 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81791
...
; 1100 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81802
...
; 1130 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81812
...
; 1189 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81825
...
; 1202 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81830
