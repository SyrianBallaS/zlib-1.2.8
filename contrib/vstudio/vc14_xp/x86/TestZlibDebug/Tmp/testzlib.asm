; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24215.1 
	...
	TITLE	C:\Users\Sam\Repos\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG84074 DB	'rb', 00H
	ORG $+5
$SG84135 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG84138 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG84139 DB	'file %s read, %u bytes', 0aH, 00H
$SG84143 DB	'1.2.8', 00H
	ORG $+2
$SG84144 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG84145 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG84146 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG84147 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG84148 DB	'1.2.8', 00H
	ORG $+2
$SG84149 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG84150 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG84151 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG84152 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG84155 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File c:\users\sam\repos\zlib-1.2.8\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
